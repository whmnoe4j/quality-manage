 ...
 */
@RegisterBean
@StrategyAnnotation(name = "null_count",description = "null数量校验")
public class NullCount extends AbstractStrategy implements Strategy {
    private static Logger logger = LoggerFactory.getLogger(NullCount.class);
